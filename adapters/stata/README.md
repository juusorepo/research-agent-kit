...
```
powershell -File "<kit>\adapters\stata\run-stata.ps1" -DoFile "02-scripts\01_draft.do" -WorkDir "."
```

The script prints `run_status`, `log_path`, `command`, and `stata_bin`. On failure it keeps the log and exits non-zero.
