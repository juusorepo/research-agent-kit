...
research-agent-kit/
├── README.md
├── START.md                           # copy the repo, say Start the project
├── SPEC.md
├── BACKLOG.md
├── CHANGELOG.md
├── LICENSE
...
**D1 settled:** researchers start by **copying this repository** and asking an agent to start the project. No git submodules. No Python or R required to start. `scripts/install.py` is an optional copy helper (and is used in kit tests). Later: update/diff; optional profiles.
