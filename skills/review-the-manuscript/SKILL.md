...
description: AI pass on the manuscript as open issues in contributions/. Use when they say Review the manuscript, AI review, coarse-review, or Scan for generic prose. Not an audit of the research chain. Do not edit the paper in this run.
license: MIT
...
6. Write each atomic finding as a contribution (`source: ai-review`) via **Contribute to the project**. Wording nits can be `type: editorial`. Method or claim issues stay issues; say **researcher decision needed** when the science would change.
