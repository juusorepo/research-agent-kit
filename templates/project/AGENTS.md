...
- You may implement, criticise, and propose. The lead researcher accepts claims and important decisions.
...
If the researcher says **Start the project** or **Initiate**, and `layout.yml` is missing, use `start-research-project`. Ask the lead researcher’s name. Copy files from the kit templates — do not require Python or R.
